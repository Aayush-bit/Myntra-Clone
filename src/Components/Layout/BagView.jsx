// this is a togglable bag pop up 
// appears when user clicks the bag icon on the navbar
// disappears when user clicks the "BACK" button on the BagView component
...
const BagView = () => {
    // getting items present in the bag
    ...
    return (
        <div id="screen-overlay">
            <div>
                ...
                <button onClick={() => dispatch(toggleBagView(false))}>back</button>
            </div>
        </div>
    )
}
